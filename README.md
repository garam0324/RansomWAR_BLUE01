...
| 이름 | 역할 | 상세 설명 |
|------|------|------|
| 고대현 | 팀장, 코드 작성 및 보완, 보고서 작성 | - write 행위 관련 코드 구현<br>- 엔트로피 기능 보완<br>- 파일 크기 감소 감지 기능 보완 |
| 김가람 | 코드 작성 및 보완, 발표 | - read, unlink, open 행위 관련 코드 구현(rate limit, 확장자/매직넘버 등)<br>- write 쿨다운 기능 추가<br>- 엔트로피 조건문 보완<br>- write rate limit 기능 보완<br>- 그 외 짜잘한 부분 보완 |
| 김준범 | 코드 작성 및 보완, ppt 제작 | - rename, create 행위 관련 코드 구현(rate limit, 확장자/매직넘버 등)<br>- |
